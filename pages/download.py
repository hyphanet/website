    ...
    return """
      <script type="text/javascript">
         ...
         if (hash == "autostart") {
            ...
            if (OSName == "macos") {
                download('https://github.com/freenet/mactray/releases/download/v2.0.5-pre1/FreenetTray_2.0.5-pre1.zip');
            }
            if (OSName == "unix") {
...
""") + "\n\n" + """
[url_mac_installer]: https://github.com/freenet/mactray/releases/download/v2.0.5-pre1/FreenetTray_2.0.5-pre1.zip
[url_gpg_sig]: https://github.com/freenet/mactray/releases/download/v2.0.5-pre1/FreenetTray_2.0.5-pre1.zip.sig
[url_keyring]: #keyring
"""))+div("unix",md(_("""
### GNU/Linux & POSIX
