...
"""
        ...
        donate_text = md(_("Help keep Internet freedom alive and expand human liberty, help us toward another year of paid development.") + " " + read_more.format("news.html#20151206-donation-appeal"))
