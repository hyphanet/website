...
> **Install Freenet** for **[Windows][windows-installer]**, for **[GNU/Linux and other *nixes][linux-installer]**, for **[Android][android-package]**, or for [other platforms][download page].
...
- configuration,
- security,
- windows installer and tray, and
- debian package
