...
У нас есть в разработке (дальнейшая работа не идет) [пакет Debian](https://github.com/freenet/debian),
...
Все, что вам на самом деле нужно - это указать системе, на которую вы скопировали заркало,
чтобы она запускала для вас прокси демон Freenet при загрузке. 
