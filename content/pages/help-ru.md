...
используя [списки рассылок](help.html#mailing-lists) Freenet, канал IRC (irc.libera.chat #freenet),
...
например, [Veracrypt](https://veracrypt.fr/). Freenet не может предотвратить все утечки личных данных,
